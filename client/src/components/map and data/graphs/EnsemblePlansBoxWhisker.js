...
export default function EnsemblePlansBoxWhisker(){
    ...
    const fetch_ensemble_data_race = async (stateAbbreviation, racialGroup) => {
        try{
            const response = await fetch(`https://votifier-server-production.up.railway.app/api/data/${stateAbbreviation}/boxplot/demographics/${racialGroup}`);
    ...
    const fetch_ensemble_data_income = async (stateAbbreviation, incomeGroup) => {
        try{
            const response = await fetch(`https://votifier-server-production.up.railway.app/api/data/${stateAbbreviation}/boxplot/economics/${incomeGroup}`);
            const json = await response.json();
            return json;
        } catch (error) {
            console.error(error.message);
    ...
    const fetch_ensemble_data_region = async (stateAbbreviation, regionType) => {
        try{
            const response = await fetch(`https://votifier-server-production.up.railway.app/api/data/${stateAbbreviation}/boxplot/region_type/${regionType}`);
            const json = await response.json();
            return json;
        } catch (error) {
            console.error(error.message);
    ...
    const fetch_ensemble_summary = async (stateAbbreviation) => {
        try{
            const response = await fetch(`https://votifier-server-production.up.railway.app/api/data/${stateAbbreviation}/plansplits`);
            const json = await response.json();
            return json;
        } catch (error) {
            console.error(error.message);
