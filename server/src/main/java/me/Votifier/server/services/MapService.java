...
public class MapService {
    ...
    public ResponseEntity<Resource> colorHeatmapDemographic(
        ...
        try {
            HashMap<Integer, Bin> loadedHeatmapBins = loadedBins.get(FeatureName.HEATMAP_DEMOGRAPHIC); 
    ...
    public ResponseEntity<Resource> colorHeatmapEconomicIncome(
        ...
        try {
            // HashMap<Integer, Bin> loadedHeatmapBins = loadedBins.get(BinsFeature.HEATMAP_ECONOMIC_INCOME); 
            ...
            // InputStreamReader precinctsPopulationGroupsBodyStream = new InputStreamReader(precinctsEconomicGroupsBody.getInputStream());
            // BufferedReader precinctsEconomicGroupsBodyReader = new BufferedReader(precinctsPopulationGroupsBodyStream);
